...
특히 생성된 답변에서 title을 제외하고는 순서 표시 숫자와 ", - 등 기호를 없애서 title만 나오도록 만들어주세요
...
위 정보를 바탕으로 3개 이상의 하위 주제와 단락을 포함한 상세하고 긴 게시물을 작성해주세요. 
각 단락은 명확한 제목과 함께 제공되어야 하며, 초보 창업자들에게 이해하기 쉽고 유용해야 합니다.
또한 길어도 좋으니 주로 수치와 사실에 입각하여 자세하고 구체적으로 작성해주세요.
